...
UPDATE departments SET manager_id = 4 WHERE department_id = 4; -- Finance
UPDATE departments SET manager_id = 5 WHERE department_id = 5; -- Supply Chain
...
(5, 2026, 12, 3),
(6, 2026, 12, 6),
(7, 2026, 12, 0), -- Nhân viên mới
(8, 2026, 12, 0), -- Nhân viên mới
(9, 2026, 12, 1),
(10, 2026, 12, 2)
