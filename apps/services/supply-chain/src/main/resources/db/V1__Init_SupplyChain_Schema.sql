...
CREATE TABLE IF NOT EXISTS product_categories (
    ...
    description TEXT, -- [MỚI] Mô tả danh mục
    status VARCHAR(50) DEFAULT 'Hoạt động' -- [MỚI] Trạng thái
);
...
CREATE TABLE IF NOT EXISTS products (
    ...
    image_url TEXT,
    description TEXT, -- [MỚI] Mô tả sản phẩm
    status VARCHAR(50) DEFAULT 'Hoạt động', -- [MỚI] Trạng thái
...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    note TEXT, -- [MỚI] Ghi chú nội bộ
    status VARCHAR(50) DEFAULT 'Đang hợp tác', -- [MỚI] Trạng thái hợp tác
    contract_url TEXT, -- [MỚI] Link file hợp đồng
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS bin_locations (
    ...
    description TEXT, -- [MỚI] Mô tả vị trí
    is_active BOOLEAN DEFAULT TRUE, -- [MỚI] Trạng thái sử dụng
...
CREATE TABLE IF NOT EXISTS current_stock (
    ...
    notes TEXT, -- [MỚI] Ghi chú lô hàng
...
CREATE TABLE IF NOT EXISTS quotations (
    ...
    status pr_status_enum, -- Sử dụng enum giống PR hoặc tạo mới nếu cần
    is_selected BOOLEAN DEFAULT FALSE -- TINYINT(1) -> BOOLEAN
);

-- [MỚI] Chi tiết báo giá (Quotation Items) - Bảng này chưa có trong code cũ
CREATE TABLE IF NOT EXISTS quotation_items (
    ...
    total_line DECIMAL(19,4) GENERATED ALWAYS AS (quantity * unit_price) STORED
);
